                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <a href="./page-android.html" class="folder">
                                    <div class="icon-small  rounded bg-primary  mb-4">
                                        <i class="ri-file-copy-line"></i>
                                    </div>
                                </a>
                                <div class="card-header-toolbar">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div data-load-file="file" data-load-target="#resolte-contaniner" data-url="assets/vendor/doc-viewer/files/demo.docx" data-toggle="modal" data-target="#exampleModal" data-title="alexa7.pptx" style="cursor: pointer;">Training center.pptx</div>
                                            </div>
                                        </td>
                                        <td>Me</td>
