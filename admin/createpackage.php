                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="validation-form" action="<?php echo BASE_URL . 'admin/action/packages/store' ?>" method="POST">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="validation-name" placeholder="Package Name">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="validation-size" placeholder="Storage Size">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="validation-price" placeholder="Price">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
